...
let cmove  a b = ins "cmove %a %b" a () b ()
let cmovne a b = ins "cmovne %a %b" a () b ()
let cmovs  a b = ins "cmovs %a %b" a () b ()
let cmovns a b = ins "cmovns %a %b" a () b ()
let cmovg  a b = ins "cmovg %a %b" a () b ()
let cmovge a b = ins "cmovge %a %b" a () b ()
let cmovl  a b = ins "cmovl %a %b" a () b ()
let cmovle a b = ins "cmovle %a %b" a () b ()
let cmova  a b = ins "cmova %a %b" a () b ()
let cmovae a b = ins "cmovae %a %b" a () b ()
let cmovb  a b = ins "cmovb %a %b" a () b ()
let cmovbe a b = ins "cmovbe %a %b" a () b ()
